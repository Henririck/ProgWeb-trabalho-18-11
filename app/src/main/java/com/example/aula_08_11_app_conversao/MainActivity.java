        ...
        rg.setOnCheckedChangeListener(((radioGroup, i) -> {
            ...
            switch (rb.getText().toString()) {
                case "Real -> Dolar":
                    ...
                    break;
                case "Peso -> Dolar":
                    opcaoSelecionada = "ARS-USD";
                    break;
                case "Bitcoin -> Dolar":
                    opcaoSelecionada = "BTC-USD";
                    break;
                case "Real -> Euro" :
        ...
        try {
            ...
            awesomeClient.buscarDados(opcaoSelecionada, new ApiCallback<String>() {
                ...
                public void onSuccess(String result) {
                    ...
                    } else if (jsonObject.has("ARSUSD")) {
                        currencyRate = gson.fromJson(jsonObject.get("ARSUSD"), CurrencyRate.class);
                    } else if (jsonObject.has("BTCUSD")) {
                        currencyRate = gson.fromJson(jsonObject.get("BTCUSD"), CurrencyRate.class);
